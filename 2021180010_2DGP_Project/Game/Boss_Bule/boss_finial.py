...
class Boss_Blue_Finial:
    ...
    def set_intro_motion(self):
        # 보스 intro 모션
        if Boss_Blue_Finial.Boss_image_Intro is None:
            Boss_Blue_Finial.Boss_image_Intro = []

            path = 'Resources/Blue_Boss/Phase 2/Idle/lg_slime_idle_000'  # main.py 기준임

            for a in range(1, 5 + 1):
                finalPath = path + str(a) + '.png'
                Boss_Blue_Finial.Boss_image_Intro.append(load_image(finalPath))

        self.image_Intro = []
        self.image_Intro = Boss_Blue_Finial.Boss_image_Intro
        pass


    def set_punch_motion(self):
        # 보스 Punch 모션
        if Boss_Blue_Finial.Boss_image_Punch is None:
            Boss_Blue_Finial.Boss_image_Punch = []

            path = 'Resources/Blue_Boss/Phase 2/Punch/lg_slime_punch_'  # main.py 기준임

            for a in range(1, 32 + 1):
                finalPath = path + str(a) + '.png'
                Boss_Blue_Finial.Boss_image_Punch.append(load_image(finalPath))

        self.image_Punch = []
        self.image_Punch = Boss_Blue_Finial.Boss_image_Punch
        pass

    def set_jump_motion(self):
        # 보스 Jump 모션
        if Boss_Blue_Finial.Boss_image_Jump is None:
            Boss_Blue_Finial.Boss_image_Jump = []

            path = 'Resources/Blue_Boss/Phase 2/Jump/boss_phase_two_jump_'  # main.py 기준임

            for a in range(1, 22 + 1):
                finalPath = path + str(a) + '.png'
                Boss_Blue_Finial.Boss_image_Jump.append(load_image(finalPath))

        self.image_Jump = []
        self.image_Jump = Boss_Blue_Finial.Boss_image_Jump
        pass

    def set_player_item_motion(self):
        # 보스 Question 모션
        if Boss_Blue_Finial.Boss_image_Question_player_item is None:
            Boss_Blue_Finial.Boss_image_Question_player_item = []

            path = 'Resources/Blue_Boss/Phase 1/Transition To Ph2/slime_morph_'  # main.py 기준임

            for a in range(1, 37 + 1):
                finalPath = path + str(a) + '.png'
                Boss_Blue_Finial.Boss_image_Question_player_item.append(load_image(finalPath))

        self.image_Question_player_item = []
        self.image_Question_player_item = Boss_Blue_Finial.Boss_image_Question_player_item
        pass

    def set_die_motion(self):
        # 보스 Change_Phase 모션
        if Boss_Blue_Finial.Boss_image_Change_Phase is None:
            Boss_Blue_Finial.Boss_image_Change_Phase = []

            path = 'Resources/Blue_Boss/Phase 2/Death/lg_slime_death_'  # main.py 기준임

            for a in range(1, 20 + 1):
                finalPath = path + str(a) + '.png'
                Boss_Blue_Finial.Boss_image_Change_Phase.append(load_image(finalPath))

        self.image_Change_Phase = []
        self.image_Change_Phase = Boss_Blue_Finial.Boss_image_Change_Phase
        pass
